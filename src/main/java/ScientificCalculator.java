...
public class ScientificCalculator {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (choice == 1) System.out.println("Result: " + squareRoot(num));
            if (choice == 2) System.out.println("Result: " + factorial((int) num));
            if (choice == 3) System.out.println("Result: " + naturalLog(num));
            if (choice == 4) {
